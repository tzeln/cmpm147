...
function cameraToWorldOffset([camera_x, camera_y]) {
  let world_x = camera_x / (tile_width_step_main * 2) - 5;
  let world_y = camera_y / (tile_height_step_main * 2) + 5;
...
function setup() {
  ...
  camera_offset = new p5.Vector(-width, height);
  camera_velocity = new p5.Vector(0, 0);
  // camera(-width/2, -height/2, height/2, width/2, height/2, 0, 0, 15, -20);
